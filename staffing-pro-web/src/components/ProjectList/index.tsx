import { type AppProject } from "../../utils/api"
              ...
              <div className="flex justify-between border border-slate-200 rounded-sm p-1 shadow">
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex flex-row-reverse">
                    <div className="badge bg-teal-100 mx-px">{project.industry.name}</div>
                    <div className="badge bg-pink-100">{project.vertical.name}</div>
                  </div>
                  <div className="flex flex-row-reverse">
                  ...
                  <div className="flex flex-row-reverse">
                    <div className="badge bg-lime-100 mx-px">{project.stage}</div>
                    <div className="badge bg-fuchsia-100 mx-px">{project.positions.length} Positions</div>
                  </div>
                </div>
              </div>
              <div className="p-2"/>
